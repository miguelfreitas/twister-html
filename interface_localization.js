...
var knownLanguages = ["en","nl","it","fr","ru","de","zh","pt"];
...
if(preferredLanguage == "pt"){
    ...
    wordset = {
      "Actions ▼": "Ações ▼",
      "Active DHT nodes:": "Nós (peers) DHT ativos: ",
      ...
      "Block chain is up-to-date, twister is ready to use!": "Cadeida de Blocos sincronizada, Twister está pronto para uso!",
      "Block generation": "Geração de blocos ",
      "Cancel": "Cancelar",
      "Change user": "Trocar de usuário",
